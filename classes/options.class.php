  ...
  class CSF_Options extends CSF_Abstract {
    ...
    public function ajax_save() {
      ...
      if( ! empty( $_POST['data'] ) ) {
        ...
        if( ! empty( $_POST[$this->unique] ) && ! empty( $_POST['csf_options_nonce'] ) && wp_verify_nonce( $_POST['csf_options_nonce'], 'csf_options_nonce' ) ) {
    ...
    public function set_options() {
      ...
      if( wp_verify_nonce( csf_get_var( 'csf_options_nonce' ), 'csf_options_nonce' ) ) {
        ...
        if( ! empty( $transient['csf_import_data'] ) ) {
          ...
          $import_data = unserialize( stripslashes( trim( $transient['csf_import_data'] ) ) );
        ...
        wp_die( esc_html__( 'Error while saving.', 'csf' ) );
      }
      ...
      echo '<div class="csf csf-options '. $this->args['framework_class'] .'" data-slug="'. $this->args['menu_slug'] .'" data-unique="'. $this->unique .'">';
        ...
        if( ! empty( $this->args['show_footer'] ) ) {
          ...
          if( ! empty( $this->args['footer_text'] ) ) {
            echo '<div class="csf-copyright">'. $this->args['footer_text'] .'</div>';
          }
